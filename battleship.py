...
def drawGrid(data, canvas, grid, showShips):
    for i in data["rows"]:
        for j in data["cols"]:
            if SHIP_UNCLICKED == True:
                data["cell_size"] = canvas.create_rectangle(200, 200, fill = "yellow", anchor="center")
            else:
                data["cell_size"] = canvas.create_rectangle(200, 200, fill = "blue", anchor="center")
    return
